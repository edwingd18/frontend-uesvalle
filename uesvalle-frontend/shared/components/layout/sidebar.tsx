  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 py-4 flex flex-col h-full">
        ...
        {!isCollapsed ? (
          <div className="px-3">
            <div className="flex items-center space-x-3 px-4 py-3 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200">
              <div className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center shadow-sm">
                <span className="text-white font-medium text-sm">
                  {usuario ? getUserInitials(usuario.nombre) : "U"}
                </span>
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-orange-600 font-medium">
                  {usuario ? getRoleDisplayName(usuario.rol) : "Usuario"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="px-3 flex justify-center">
            <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center shadow-sm group relative">
